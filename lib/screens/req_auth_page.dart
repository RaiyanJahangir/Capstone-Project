      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        return ListView(
          children: snapshot.data!.docs.map((DocumentSnapshot document) {
            ...
            Iterable i = reqname
                .where((name) => name.contains(loggedInUser.email.toString()))
                .toList();
            //print(i);
            ...
            i = reqname
                .where((name) => name.contains(loggedInUser.uid.toString()))
                .toList();
            print(i);
                ...
                onPressed: () async {
                  if (req == false && g == false && n == false) {
                    await FirebaseFirestore.instance
                        ...
                        .doc(data['baby_uid'])
                        .update({
                      "req": FieldValue.arrayUnion([loggedInUser.email])
                    });
